...
class modxExtensionOfficeItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('modxextension_item_err_ns');
        }
...
return 'modxExtensionOfficeItemUpdateProcessor';
